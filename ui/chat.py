...
with gr.Blocks(title="Prem Assistant", fill_height=True, fill_width=True) as interface:
    gr.Markdown("## ✨ Prem Assistant")
    ...
    msg = gr.MultimodalTextbox(
        placeholder="Message Prem... (attach a screenshot for support issues)",
        show_label=False,
        sources=["upload"],
        file_types=["image"],
        file_count="single",
